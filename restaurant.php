...
$query = $mysqli->prepare("SELECT r.name , r.id , c.cuisine FROM restaurants r INNER JOIN restaurant_has_cuisines rhc on r.id= rhc.restaurant_id INNER JOIN cuisines c on rhc.cuisine_id = c.id where r.id = ?");
